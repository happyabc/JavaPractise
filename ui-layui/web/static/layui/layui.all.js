...
;!function (e) {
    ...
    n.prototype.cache = o, n.prototype.define = function (e, t) {
        ...
        var p = this, y = o.dir = o.dir ? o.dir : r, d = t.getElementsByTagName("head")[0];
        ...
        "string" == typeof n && (r = n);
        var s = (r || e).replace(/\.|\//g, ""), c = u.id = "layuicss-" + s, p = 0;
        ...
        var r = this, i = null, a = t.match(/\(.*\)$/) || [], u = (t = e + "." + t).replace(a, ""),
            l = function (e, t) {
                var o = t && t.call(r, n);
                o === !1 && null === i && (i = !1)
            };
...
layui.define("jquery", function (i) {
    "use strict";
    var t = layui.$, a = (layui.hint(), layui.device()), e = "element", l = "layui-this", n = "layui-show",
        s = function () {
            this.config = {}
        };
    s.prototype.set = function (i) {
        ...
        var e = ".layui-tab-title", l = t(".layui-tab[lay-filter=" + i + "]"), n = l.children(e),
        ...
        var e = "layui-progress", l = t("." + e + "[lay-filter=" + i + "]"), n = l.find("." + e + "-bar"),
            s = n.find("." + e + "-text");
        return n.css("width", a), s.text(a), this
    };
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, a, s, o) {
                o = o || {};
                var c = s || t(this), a = a || c.parent().children("li").index(c),
                    ...
                    d = c.find("a"), h = r.attr("lay-filter");
                ...
                var n = a || t(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0),
                    c = o.children(".layui-tab-content").children(".layui-tab-item"), r = o.attr("lay-filter");
                n.hasClass(l) && (n.next()[0] ? y.tabClick.call(n.next()[0], null, s + 1) : n.prev()[0] && y.tabClick.call(n.prev()[0], null, s - 1)), n.remove(), c.eq(s).remove(), setTimeout(function () {
                    y.tabAuto()
                }, 50), layui.event.call(this, e, "tabDelete(" + r + ")", {elem: o, index: s})
            }, tabAuto: function () {
                var i = "layui-tab-more", e = "layui-tab-bar", l = "layui-tab-close", n = this;
                t(".layui-tab").each(function () {
                    var s = t(this), o = s.children(".layui-tab-title"),
                ...
                var i = t(this), a = i.parents(o), n = a.attr("lay-filter"), s = i.find("a"),
    ...
    s.prototype.init = function (i, e) {
        var l = function () {
            ...
            tab: function () {
                ...
                var i = 200, e = {}, s = {}, p = {}, v = function (l, o, c) {
                    var r = t(this), y = r.find("." + d);
                    o.hasClass(u) ? l.css({
                        top: r.position().top,
                ...
                t(o + l).each(function (a) {
                    var l = t(this), o = t('<span class="' + r + '"></span>'), f = l.find("." + c);
                ...
                t(i + l).each(function () {
                    var i = t(this), a = "lay-separator", e = i.attr(a) || "/", l = i.find("a");
                ...
                t("." + i + l).each(function () {
                    var a = t(this), e = a.find(".layui-progress-bar"), l = e.attr("lay-percent");
                ...
                t("." + i + l).each(function () {
                    ...
                    i.each(function () {
                        var i = t(this), a = i.find(".layui-colla-title"), e = i.find(".layui-colla-content"),
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.hint(),
        ...
        w = ".layui-table-sort", N = "layui-table-edit", F = "layui-table-hover", W = function (e) {
                ...
                0 !== a.length && (r || (a[d.config.indexName] = e), c.eachCols(function (e, n) {
                    ...
                    if (void 0 !== h && null !== h || (h = ""), !(n.colspan > 1)) {
                        var y = ['<td data-field="' + r + '" ' + function () {
                            ...
                            var e = t.extend(!0, {LAY_INDEX: f}, a);
...
layui.define("jquery", function (e) {
    ...
    var t = layui.$, i = {
        fixbar: function (e) {
            ...
            var o = this, a = "function" == typeof t, r = new Date(e).getTime(),
                n = new Date(!t || a ? (new Date).getTime() : t).getTime(), l = r - n,
...
layui.define(["layer", "form"], function (t) {
    ...
    c.prototype.set = function (t) {
        ...
        i = i || {};
        var a = this, n = a.config, r = "layui-layedit", c = e("#" + t), u = "LAY_layedit_" + ++a.index,
            d = c.next("." + r), y = e.extend({}, n, i), f = function () {
                var t = [], e = {};
